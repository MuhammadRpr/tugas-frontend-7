...
export default function Home() {
  return (
    <main className="bg-[url('/image/bg-home.jpg')] bg-cover bg-center h-screen">
      <div className="text-white mx-auto flex flex-col items-left justify-center h-screen text-left gap-10 px-40">
